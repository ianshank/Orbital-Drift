...
STORIES: tuple[Story, ...] = (
    ...
    Story("S6.1", "S6.1 Serving liveness-healthy container", "E6", "AC: Docker HEALTHCHECK and compose probe /livez; /readyz and /healthz stay 503 until a production model is loaded (T059); Dockerfile port env is ORBITAL_DRIFT_SERVING_PORT matching config.serving_port. Trace: T053.", (_L, "serve"), 5, "High"),
